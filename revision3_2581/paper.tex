...
\Abstract{ A wide range of chemical information is freely available
  ...
  allows users to automatically query chemical data from currently 11
...
documentation (using \pkg{roxygen2}; \citealt{wickham_roxygen2:_2015})
...
\citep{wickham_httr} for data transfer, \pkg{stringr}
\citep{wickham_stringr:_2015} for string handling, \pkg{xml2}
...
from 11 sources.  These cover a broad spectrum of available data, like
...
version is available from GitHub and also permanently available at
\citet{zenodo}.  This document has been created using \pkg{webchem}
version 0.4.0.
